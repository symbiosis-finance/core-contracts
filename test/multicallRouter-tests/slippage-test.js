...
describe("MulticallRouter tests", function () {
    ...
    it("Should check slippage fail (first swap)", async () => {
        let amountIn = 10000;
        ...
        await expect(tx).to.be.revertedWith('Swap didn\'t result in min tokens\'');
    ...
    it("Should check slippage fail (second swap)", async () => {
        let amountIn = 10000;
